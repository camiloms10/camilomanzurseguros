...
export const trustLogos: TrustLogo[] = [
  { name: "AXA", src: "/insurers/axa.png", logoClassName: "h-6 max-w-[2.55rem] object-contain" },
  ...
  { name: "Bupa", src: "/insurers/bupa.svg", logoClassName: "h-6 max-w-[5.35rem] object-contain" },
