...
export const trustLogos: TrustLogo[] = [
  { name: "AXA", src: "/insurers/axa.png", logoClassName: "h-[2.1rem] max-w-[3.15rem] object-contain" },
  ...
  { name: "Bupa", src: "/insurers/bupa.svg", logoClassName: "h-[2.1rem] max-w-[6.25rem] object-contain" },
  ...
  { name: "Plan Seguro", src: "/insurers/plan-seguro.png", logoClassName: "h-9 max-w-[6.5rem] object-contain" },
];
